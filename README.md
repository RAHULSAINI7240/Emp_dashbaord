...
- `extension`: VS Code extension for employee activity tracking and worklog sync
...
- VS Code extension calls the backend at `http://localhost:3000`
...
The extension points to `http://localhost:3000` by default.
...
2. `autovyn-backend`
3. `autovyn-web`
4. `extension` development host if needed
